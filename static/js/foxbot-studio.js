...
/* FoxBot Action Result Popup v2
   Restores the helpful click feedback popup without adding extra admin panels.
*/
(function () {
  ...
  function wrapActionFunction(name) {
    ...
    if (typeof original !== "function" || original.foxbotWrapped) return;
